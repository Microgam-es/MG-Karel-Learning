...
class Week3Test : WorldTestBase() {
    @Test
    fun partyAgain() {
        testAfterEachGoalOf(Problem.partyAgain) {
    ...
    @Test
    fun fetchTheStars() {
        testAfterEachGoalOf(Problem.fetchTheStars) {
            assertKarelAt(9, 8, EAST)
            assertNumberOfBeepers(10)
    ...
    @Test
    fun secureTheCave() {
        testAfterEachGoalOf(Problem.secureTheCave) {
            for (x in 0..9) {
    ...
    fun layAndRemoveTiles() {
        testAfterEachGoalOf(Problem.layAndRemoveTiles) {
    ...
    @Test
    fun findShelters() {
        testAfterEachGoalOf(Problem.findShelters) {
    ...
    @Test
    fun addSmart() {
        testAfterEachGoalOf(Problem.addSmart) {
    ...
    fun computeFibonacci() {
        testAfterEachGoalOf(Problem.computeFibonacci) {
